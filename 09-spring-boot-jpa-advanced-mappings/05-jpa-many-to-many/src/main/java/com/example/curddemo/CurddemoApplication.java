...
import com.example.curddemo.entity.*;
...
//		create more course
		...
		Course tempCourse2 = new Course("Jpa Many to Many");
...
//		create the course
		Course tempCourse = new Course("Coding class");

//		create the student
		Student tempStudent1 = new Student("Tom", "Mac", "tom@gmail.com");
		Student tempStudent2 = new Student("Mic", "Mac", "mic@gmail.com");

//		add the student and course
		tempCourse.addStudent(tempStudent1);
		tempCourse.addStudent(tempStudent2);

//		save
		System.out.println("Save the course: " + tempCourse);
		System.out.println("Save the associated student: " + tempCourse.getStudents());
